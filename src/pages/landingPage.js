    ...
    <Landing>
      ...
      <div className={["row", styles.flex].join(" ")}>
        <div className={["eight", "columns", styles.left].join(" ")}>
          <animated.h1
            className={[styles.copy, styles.h1].join(" ")}
            style={animation}
          >
            Kenzo Nawa
          </animated.h1>
          <animated.h2
            className={[styles.copy, styles.h2].join(" ")}
            style={animation2}
          >
            Product Designer
          </animated.h2>
          <animated.h3
            className={[styles.copy, styles.h3].join(" ")}
            style={animation3}
          >
            I'm deeply passionate about consumer-facing mobile apps and
            artificial intelligence.
          </animated.h3>
          <animated.div style={animation5}>
            <Link to="/home/">
              <Button ghost>View Work</Button>
            </Link>
          </animated.div>
        </div>
